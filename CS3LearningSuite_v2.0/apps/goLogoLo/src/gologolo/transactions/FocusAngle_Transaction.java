...
public class FocusAngle_Transaction implements jTPS_Transaction{
    ...
    public FocusAngle_Transaction(LogoData thisData,GoLogoLo appLogo,LogoPrototype component,double newAngle,boolean isCircles,boolean isImages,boolean isRectangles){
        data=thisData;
