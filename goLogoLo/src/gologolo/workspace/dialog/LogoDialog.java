 ...
 * @author jasoncao
 */
public class LogoDialog extends Stage {
    GoLogoLo app; 
    ...
    public LogoDialog(GoLogoLo initApp) {
    ...
    private void initDialog() {
        ...
        initGridNode(nameLabel,             LOGO_ADD_DIALOG_NAME_LABEL,        CLASS_LOGO_DIALOG_PROMPT,       0, 1, 1, 1, true);
    ...
    public void showAddRectangleDialog(){
     ...
     private void makeNewItem() {
       ...
       // newItem = new LogoPrototype(name);
       if(name!=""){
       
        newItem = new LogoPrototype(name,"Rectangle");
        this.hide();
       }
       else{
            newItem = new LogoPrototype("DEFAULT","Rectangle");
        this.hide();
       }
    }
